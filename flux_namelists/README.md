...
rst_on24- Sensitivity. Takes the restart file from the fluxoff simulation and restarts the simulation at this point with fluxes turned on.
- for example, rst_on24 for init0300z. Finds restart file wrfrst0400z from fluxoff, then initializes the simulation with this file. isfflx=1
